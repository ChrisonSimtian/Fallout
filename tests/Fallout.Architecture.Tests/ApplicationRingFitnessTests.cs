...
{
    // Application-ring types are spread across three assemblies: Fallout.Build (root/Execution/CI/Utilities),
    // Fallout.Tooling (Application.Tooling vocabulary + ports), and Fallout.Common (Application.Tools.*).
