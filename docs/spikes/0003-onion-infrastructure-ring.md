...
- **5c — ProjectModel/Solution**: `Fallout.Solutions` namespace → `Fallout.Infrastructure.*`.
- **5d — impure IO executors**: filesystem/glob/compression execution → `Fallout.Infrastructure.*`.
